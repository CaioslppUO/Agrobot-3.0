...
from lidar.srv import log_error,log_info,log_warning
...
def write_log(log_type,msg) -> str:
    try:
        with open(log_dir+"log.txt","a") as file:
            current_time = datetime.now().strftime("%H:%M:%S")
